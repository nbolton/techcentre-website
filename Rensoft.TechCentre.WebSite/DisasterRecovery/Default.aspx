...
<asp:Content ID="Content1" ContentPlaceHolderID="StandardContentPlaceHolder" runat="server">
    ...
    <ul>
        ...
        <li>Main Meeting Point Facilities</li>
    </ul>
    <p>To discuss your unique requirements <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Contact.aspx">call us today</asp:HyperLink>, for a no obligation tour of our facilities.</p>
</asp:Content>
