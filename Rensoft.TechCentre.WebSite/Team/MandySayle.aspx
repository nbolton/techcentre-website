...
<asp:Content ID="Content1" ContentPlaceHolderID="StandardContentPlaceHolder" runat="server">
    <div class="teamProfile">
        ...
        <p>Mandy has worked for TechCentre for under a year as our Office Manager &amp; Coordinator. She has a wealth of knowledge and experience from her 9½ years at a local law firm. Mandy enjoys the daily interaction with TechCentre clients and as the first port of call, feels that a friendly and helpfull attitude comes in very handy when problems arise.</p>
        <p>When Mandy is not working she enjoys yoga, walking, reading and spending time with her partner and daughter.</p>
